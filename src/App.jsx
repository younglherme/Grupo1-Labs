  ...
  const equipe = [
    {
      ...
      nome: "Tulani Souza",
      foto: Tulani,
      descricao: "Desenvolvedora FullStack | Cybersecurity & Ethical Hacking | Gestora de TI",
    ...
    >
      ...
      <div className="relative z-8 max-w-7xl mx-auto p-6 md:p-10">
        <header className="text-center mb-10">
          ...
          <p className="mt-4 text-xl text-gray-200">Inovação e Performance: Conheça os talentos por trás do G1 Labs.</p>
        </header>
        ...
        <main className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 items-stretch max-w-7xl mx-auto">
          {equipe.map((membro) => (
            ...
            >
              ...
              <h2 className="text-3xl font-bold mb-2 tracking-tight">{membro.nome}</h2>
              ...
              <div className="flex justify-center gap-4 w-full mt-auto">
                <a 
                  ...
                  title="LinkedIn"
                >
                  <img src={Linkedin} alt="LinkedIn" className="h-6 w-6 object-contain opacity-70 group-hover:opacity-100" />
                </a>
                <a 
                  href={membro.github} 
                  target="_blank" 
                  ...
                  title="GitHub"
                >
                  <img src={github} alt="GitHub" className="h-6 w-6 object-contain opacity-70 group-hover:opacity-100" />
                </a>
              </div>
            </div>
          ))}
